...
void Exercises::pull(){
  ...
  //back exercises
  string back_exercises [] = {"Deadlifts: 5-10 reps", "NOTHING", "Barbell Row: 10-12 reps", "Underhand EZ Bar Row: 10-12 reps", "Pull-ups/Chin-ups: 5-10 reps", "Power Cleans: 5-8 reps", "Lat Pulldowns: 10-12 reps", "Seated Cable Rows: 10 reps", "Dumbbell Rows: 8-12 reps each arm", "Face Pulls: 10-12 reps", "Chest Supported Rows: 8-10 reps"};
  //bicep  exercises
...
void Exercises::push(){
  ...
  string compound_push [] = {"Bench Press: 5-10 reps", "NOTHING", "Incline Bench Press: 5-10 reps", "Overhead Press: 8-12 reps", "Dumbbell Press: 5-10 reps", "Dumbbell Incline Press: 8-12 reps", "Push-ups: 10-25 reps", "Dumbbell Overhead Press: 8-12 reps", "Dips: 8-12 reps", "Shoulder Press: 8-12 reps"};
